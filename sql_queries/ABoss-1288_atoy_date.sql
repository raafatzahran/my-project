-- Queue: KivenlahtiOflow, KivenlahtiBf groupn by: Date, choose: 02-01-2018 (Answered:55)
SELECT 
	MAX(CASE ql.EVENT 
...
HAVING state IS NOT NULL  AND state IN ('timeout', 'noAnswer')  -- ('answer') ('timeout', 'noAnswer') 
