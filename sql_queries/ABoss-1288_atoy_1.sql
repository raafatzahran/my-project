...
WHERE  	ql.EVENT IN ('ENTERQUEUE','DID','CONNECT','COMPLETEAGENT','COMPLETECALLER','TRANSFER','EXITWITHKEY','ABANDON','EXITEMPTY','EXITWITHTIMEOUT') AND 
		q.queuename IN ('8033') AND 
		q.EVENT='ENTERQUEUE'  AND
		q.TIME > '2018-01-01 01:00:00.0' AND 
		q.TIME < '2018-02-01 00:59:00.0' 
GROUP BY ql.callId 
HAVING state IS NOT NULL -- AND state IN ('timeout', 'noAnswer') -- ('timeout', 'noAnswer') -- ('answer') -- IN ('answer') 
...
WHERE 	q.Event='ENTERQUEUE' AND 
		...
		q.queuename = q1.queuename  AND q.queuename IN ('8001','8003')AND 
		q.TIME > '2018-01-01 01:00:00.0' AND 
		q.TIME < '2018-02-01 00:59:00.0' 
