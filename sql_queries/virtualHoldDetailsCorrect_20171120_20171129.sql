-- ....................................................
select id, projectJob, reference, created, callState, contactResponse, callLength, customerId, dialHistoryIndex   from tmg_customer.dialHistory where created > '2017-11-20 00:00' and created < '2017-11-30 23:59' order by created asc;
select * from tmg_customer.virtualhold where timestamp > '2017-11-20 00:00' and timestamp < '2017-11-30 23:59' order by timestamp asc;
...
(SELECT dh.contactResponse FROM tmg_customer.dialHistory dh 
WHERE dh.id = vh.customerActivityId 
AND dh.created > vh.timestamp 
AND (dh.created < vh2.timestamp OR vh.timestamp = vh2.timestamp) 
ORDER BY dh.created  DESC LIMIT 1) AS dhContactResponse2,
	...
	where vh.timestamp > '2017-09-18 00:00' 
		and vh.timestamp <= '2017-12-14 23:59'
